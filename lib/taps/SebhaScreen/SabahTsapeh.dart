...
class SabahTsapeh extends StatefulWidget {
  static const String roudeName = 'SabahTsapeh';

  @override
  State<SabahTsapeh> createState() => _SabahTsapehState();
}

class _SabahTsapehState extends State<SabahTsapeh> {
  double angle = 0;
  ...
  void Sbah() {
    if (index == 1 &&
      ...
      Number++;
      index = 0;
    } else if (index == 100 && (Number == 28 || Number == 29 || Number == 30)) {
      Number++;
      index = 0;
    } else if (index == 4 && (Number == 7)) {
      Number++;
      index = 0;
    } else if (index == 10 && (Number == 21)) {
      Number++;
      index = 0;
    } else if (index == 7 && (Number == 9)) {
      Number++;
      index = 0;
    }
    if (Number > tsapeh.length - 1) {
